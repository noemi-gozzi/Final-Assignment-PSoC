...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=true, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=49, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_Blinking, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Blinking, CY_INSTANCE_SHORT_NAME=Timer_Blinking, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Timer_Blinking, )
...
module top ;
	...
	wire [0:0] tmpOE__CS_1_net;
	wire [0:0] tmpFB_0__CS_1_net;
	wire [0:0] tmpIO_0__CS_1_net;
	wire [0:0] tmpINTERRUPT_0__CS_1_net;
	electrical [0:0] tmpSIOVREF__CS_1_net;
	...
	assign tmpOE__Pin_ISR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d0414ade-eacb-45ea-8b31-88a0970a3441"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aad08657-b6d8-47b0-9f2b-669e953f9575"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0158749d-9271-40ec-bee0-affa3c5495be"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cfae5f87-44e9-40f2-b331-d5f92dcfefdb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__BLU_net;
	wire [0:0] tmpFB_0__BLU_net;
	wire [0:0] tmpIO_0__BLU_net;
	wire [0:0] tmpINTERRUPT_0__BLU_net;
	electrical [0:0] tmpSIOVREF__BLU_net;

	cy_psoc3_pins_v1_10
		#(.id("bd9894b0-3415-401b-b327-56cc4708cf19"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		BLU
		 (.oe(tmpOE__BLU_net),
		  .y({Net_1356}),
		  .fb({tmpFB_0__BLU_net[0:0]}),
		  .io({tmpIO_0__BLU_net[0:0]}),
		  .siovref(tmpSIOVREF__BLU_net),
		  .interrupt({tmpINTERRUPT_0__BLU_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLU_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MOSI_2_net;
	wire [0:0] tmpFB_0__MOSI_2_net;
	wire [0:0] tmpIO_0__MOSI_2_net;
	wire [0:0] tmpINTERRUPT_0__MOSI_2_net;
	electrical [0:0] tmpSIOVREF__MOSI_2_net;

	cy_psoc3_pins_v1_10
		#(.id("77d874cf-6b9f-485e-8b9b-75ec09f87dc0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MOSI_2
		 (.oe(tmpOE__MOSI_2_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__MOSI_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSI_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SCKL_2_net;
	wire [0:0] tmpFB_0__SCKL_2_net;
	wire [0:0] tmpIO_0__SCKL_2_net;
	wire [0:0] tmpINTERRUPT_0__SCKL_2_net;
	electrical [0:0] tmpSIOVREF__SCKL_2_net;

	cy_psoc3_pins_v1_10
		#(.id("9e0dac85-9656-48c0-8dfa-2ee06ca45b2b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SCKL_2
		 (.oe(tmpOE__SCKL_2_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__SCKL_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCKL_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CS_2_net;
	wire [0:0] tmpFB_0__CS_2_net;
	wire [0:0] tmpIO_0__CS_2_net;
	wire [0:0] tmpINTERRUPT_0__CS_2_net;
	electrical [0:0] tmpSIOVREF__CS_2_net;

	cy_psoc3_pins_v1_10
		#(.id("469246ef-31bc-4fad-b1b0-0f6ef3710729"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		CS_2
		 (.oe(tmpOE__CS_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CS_2_net[0:0]}),
		  .io({tmpIO_0__CS_2_net[0:0]}),
		  .siovref(tmpSIOVREF__CS_2_net),
		  .interrupt({tmpINTERRUPT_0__CS_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CS_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MISO_2_net;
	wire [0:0] tmpIO_0__MISO_2_net;
	wire [0:0] tmpINTERRUPT_0__MISO_2_net;
	electrical [0:0] tmpSIOVREF__MISO_2_net;

	cy_psoc3_pins_v1_10
		#(.id("ca3d3356-333c-4fda-a4c1-c9c9824d9340"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Debouncer_v1_0 DEBOUNCER_switch (
        .d(Net_214),
        .clock(Net_136),
        .q(Net_2599),
        .neg(Net_316),
        .either(Net_2600),
        .pos(Net_2601));
    defparam DEBOUNCER_switch.EitherEdgeDetect = 0;
    defparam DEBOUNCER_switch.NegEdgeDetect = 1;
    defparam DEBOUNCER_switch.PosEdgeDetect = 1;
    defparam DEBOUNCER_switch.SignalWidth = 1;

	wire [0:0] tmpOE__SWITCH_IN_net;
	wire [0:0] tmpIO_0__SWITCH_IN_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_IN_net;
	electrical [0:0] tmpSIOVREF__SWITCH_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("784112f3-24e2-4b9b-a877-c8a3ecb199f3"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_IN
		 (.oe(tmpOE__SWITCH_IN_net),
		  .y({1'b0}),
		  .fb({Net_214}),
		  .io({tmpIO_0__SWITCH_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_IN_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("fdfeb9cd-5ea5-4bf4-872b-f692b3c0457c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam Timer_Blinking.InterruptOnCapture = 0;
    defparam Timer_Blinking.InterruptOnTC = 1;
    defparam Timer_Blinking.Resolution = 8;
    defparam Timer_Blinking.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Pin_RED_UARTVerboseFlag_net;
	wire [0:0] tmpFB_0__Pin_RED_UARTVerboseFlag_net;
	wire [0:0] tmpIO_0__Pin_RED_UARTVerboseFlag_net;
	wire [0:0] tmpINTERRUPT_0__Pin_RED_UARTVerboseFlag_net;
	electrical [0:0] tmpSIOVREF__Pin_RED_UARTVerboseFlag_net;

	cy_psoc3_pins_v1_10
		#(.id("2e2ff3fa-7d0d-4a8d-a096-f9e05bfe3da8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pin_RED_UARTVerboseFlag
		 (.oe(tmpOE__Pin_RED_UARTVerboseFlag_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_RED_UARTVerboseFlag_net[0:0]}),
		  .io({tmpIO_0__Pin_RED_UARTVerboseFlag_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_RED_UARTVerboseFlag_net),
		  .interrupt({tmpINTERRUPT_0__Pin_RED_UARTVerboseFlag_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_RED_UARTVerboseFlag_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_EnableDisable_net;
	wire [0:0] tmpFB_0__Pin_EnableDisable_net;
	wire [0:0] tmpIO_0__Pin_EnableDisable_net;
	electrical [0:0] tmpSIOVREF__Pin_EnableDisable_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9af7fcf2-989b-495d-ac99-2ba422b1dcef"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_EnableDisable
		 (.oe(tmpOE__Pin_EnableDisable_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_EnableDisable_net[0:0]}),
		  .io({tmpIO_0__Pin_EnableDisable_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_EnableDisable_net),
		  .interrupt({Net_2711}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_EnableDisable_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
